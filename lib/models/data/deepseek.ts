...
const deepseekModels: ModelConfig[] = [
  {
    ...
    apiSdk: async (userId?: string) => await openproviders("deepseek/deepseek-r1:free", undefined, userId),
  },
  {
    id: "deepseek-v3",
    name: "DeepSeek-V3",
    ...
    apiSdk: async (userId?: string) => await openproviders("deepseek-v3", undefined, userId),
  },
]
